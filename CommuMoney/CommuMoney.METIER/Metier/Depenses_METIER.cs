...
namespace CommuMoney.METIER.Metier
{
    public class Depenses_METIER
    {
        ...
        public Depenses_METIER(int id_personne, int id_projet, double montant) => (ID_Personne, ID_Projet, Montant) = (id_personne, id_projet, montant);
        public Depenses_METIER(int id, int id_personne, int id_projet, double montant) => (ID, ID_Personne, ID_Projet, Montant) = (id, id_personne, id_projet, montant);
