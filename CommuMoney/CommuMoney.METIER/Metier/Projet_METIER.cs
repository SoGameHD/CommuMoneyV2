...
namespace CommuMoney.METIER.Metier
{
    public class Projet_METIER
    {
        ...
        public Projet_METIER(string nom, int id_personne, double total_montant, double moyenne, DateTime? date_soiree) => (Nom, ID_Personne, Total_Montant, Moyenne, Date_Soiree) = (nom, id_personne, total_montant, moyenne, date_soiree);
        public Projet_METIER(int id, string nom, int id_personne, double total_montant, double moyenne, DateTime? date_soiree) => (ID, Nom, ID_Personne, Total_Montant, Moyenne, Date_Soiree) = (id, nom, id_personne, total_montant, moyenne, date_soiree);
